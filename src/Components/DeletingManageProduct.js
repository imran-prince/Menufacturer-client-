...
const DeletingManageProduct = ({ deletingProduct, refetch, setDeletingProduct }) => {
    const { productName, _id } = deletingProduct
    const handelDelete = () => {
        fetch(`https://guarded-inlet-86447.herokuapp.com/manageproduct/${_id}`, {
            method: "DELETE",
            headers: {
...
export default DeletingManageProduct;